...
class Star {
    constructor() {
        this.reset();
        this.baseSpeed = 0.5; // Normal movement speed
        this.speedMultiplier = 2; // Speed multiplier when near mouse
    }
    ...
    update() {
        ...
        this.speed = dist < 100 ? this.baseSpeed * this.speedMultiplier : this.baseSpeed;
